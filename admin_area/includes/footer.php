		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">rTrack an orde</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Camshop<br>
				jl.suryajayanegara kec.jamblang, Cirebon.
			</address>
				<div class="phone">
					Telephone:
				...
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">Camshop@gmail.com</a>
				</div>
			</div>
